...
@click_option_setenv('--dispatcher-url', envvar='DISPATCHER_URL', type=str, help='The URL that the internal dispatcher would contact')
@click_option_setenv('--dispatcher-image', envvar='DISPATCHER_IMAGE', type=str, help='The docker image that the internal dispatcher would use')
