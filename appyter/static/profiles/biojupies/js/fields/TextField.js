...
/* profiles/biojupies/js/fields/TextField.svelte generated by Svelte v3.46.4 */
...
function create_each_block(ctx) {
  ...
  const block = {
    c: function create() {
      ...
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(button, file, 47, 14, 1594);
