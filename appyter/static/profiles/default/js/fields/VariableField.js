...
/* harmony import */ var _home_u8sand_Programs_work_active_appyter_js_node_modules_svelte_hmr_runtime_proxy_adapter_dom_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/svelte-hmr/runtime/proxy-adapter-dom.js */ "./node_modules/svelte-hmr/runtime/proxy-adapter-dom.js");
/* module decorator */ module = __webpack_require__.hmd(module);
/* profiles/default/js/fields/VariableField.svelte generated by Svelte v3.46.4 */
...
function create_each_block(key_1, ctx) {
  ...
  const block = {
    ...
    c: function create() {
      ...
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(button, "class", "btn btn-sm btn-danger");
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.set_style)(button, "float", "right");
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(button, "data-target", button_data_target_value =
      /*value_id*/
      ctx[5]);
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(button, file, 31, 4, 836);
      this.first = button;
    },
    m: function mount(target, anchor) {
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.insert_dev)(target, button, anchor);
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.append_dev)(button, i);
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.insert_dev)(target, t, anchor);
    ...
    p: function update(new_ctx, dirty) {
      ...
      if (!current || dirty &
      /*fields*/
      2 && button_data_target_value !== (button_data_target_value =
      /*value_id*/
      ctx[5])) {
        (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(button, "data-target", button_data_target_value);
      }
...
function create_fragment(ctx) {
  ...
  const block = {
    c: function create() {
      ...
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(i, file, 55, 5, 1618);
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(button, "class", "btn btn-sm btn-success");
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.set_style)(button, "float", "right");
      ...
      /*args*/
      ctx[0].max;
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.toggle_class)(button, "disabled",
      /*args*/
      ctx[0].max &&
      /*fields*/
      ctx[1].length >
      /*args*/
      ctx[0].max);
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(button, file, 46, 4, 1216);
      ...
      /*args*/
      ctx[0].value;
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(input, file, 60, 2, 1713);
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.set_style)(div3, "display", "none");
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(div3, file, 59, 0, 1683);
    },
    l: function claim(nodes) {
      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    },
    ...
    p: function update(ctx, [dirty]) {
      ...
      /*args*/
      ctx[0].value) && input.value !== input_value_value) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  const click_handler_1 = () => {
    ...
    $$invalidate(1, fields[$$invalidate(2, id_counter++, id_counter)] = { ...args.field,
      args: { ...args.field.args,
        name: `${args.field.args.name}${id_counter}`
      }
    }, fields);
  ...
  $$self.$$.update = () => {
    ...
    /*fields*/
    2) {
      $: $$invalidate(0, args.value = JSON.stringify(Object.values(fields).map(field => ({
        '$ref': `#/${field.args.name}`
      }))), args);
    }
  };
...
/* harmony default export */ __webpack_exports__["default"] = (VariableField);
