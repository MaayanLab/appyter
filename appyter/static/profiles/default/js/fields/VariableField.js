...
/***/ "./profiles/default/js/fields/VariableField.svelte":
/*!*********************************************************!*\
  !*** ./profiles/default/js/fields/VariableField.svelte ***!
  \*********************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _home_u8sand_Programs_work_active_appyter_js_node_modules_svelte_hmr_runtime_proxy_adapter_dom_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/svelte-hmr/runtime/proxy-adapter-dom.js */ "./node_modules/svelte-hmr/runtime/proxy-adapter-dom.js");
/* module decorator */ module = __webpack_require__.hmd(module);
/* profiles/default/js/fields/VariableField.svelte generated by Svelte v3.42.1 */


const { Object: Object_1 } = svelte_internal__WEBPACK_IMPORTED_MODULE_0__.globals;

const file = "profiles/default/js/fields/VariableField.svelte";
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(i, file, 26, 58, 674);
			...
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(sup, file, 26, 6, 622);
		},
		m: function mount(target, anchor) {
	...
	(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.dispatch_dev)("SvelteRegisterBlock", {
		...
		id: create_if_block.name,
		type: "if",
		source: "(26:4) {#if args.description}",
		ctx
	});
...
// (31:4) {#each Object.keys(fields) as value_id (value_id)}
function create_each_block(key_1, ctx) {
	...
	function click_handler() {
		return /*click_handler*/ ctx[3](/*value_id*/ ctx[5]);
	}

	ssrfield = new _components_app_SSRField_svelte__WEBPACK_IMPORTED_MODULE_1__["default"]({
			props: {
				field: /*fields*/ ctx[1][/*value_id*/ ctx[5]].field,
				args: /*fields*/ ctx[1][/*value_id*/ ctx[5]].args
			},
			$$inline: true
		});
	...
	const block = {
		...
		c: function create() {
			...
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(i, "class", "fas fa-trash text-white");
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(i, file, 40, 5, 1050);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(a, "href", "javascript:");
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(a, "class", "btn btn-sm btn-danger");
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.set_style)(a, "float", "right");
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(a, "data-target", a_data_target_value = /*value_id*/ ctx[5]);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(a, file, 31, 4, 836);
			this.first = a;
		},
		m: function mount(target, anchor) {
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.insert_dev)(target, a, anchor);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.append_dev)(a, i);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.insert_dev)(target, t, anchor);
		...
		p: function update(new_ctx, dirty) {
			...
			if (!current || dirty & /*fields*/ 2 && a_data_target_value !== (a_data_target_value = /*value_id*/ ctx[5])) {
				(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(a, "data-target", a_data_target_value);
			}

			const ssrfield_changes = {};
			if (dirty & /*fields*/ 2) ssrfield_changes.field = /*fields*/ ctx[1][/*value_id*/ ctx[5]].field;
			if (dirty & /*fields*/ 2) ssrfield_changes.args = /*fields*/ ctx[1][/*value_id*/ ctx[5]].args;
	...
	(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.dispatch_dev)("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(31:4) {#each Object.keys(fields) as value_id (value_id)}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	let mounted;
	let dispose;
	let if_block = /*args*/ ctx[0].description && create_if_block(ctx);
	let each_value = Object.keys(/*fields*/ ctx[1]);
	(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.validate_each_argument)(each_value);
	const get_key = ctx => /*value_id*/ ctx[5];
	...
	const block = {
		c: function create() {
			...
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(div0, file, 23, 2, 522);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(i, "class", "fas fa-plus text-white");
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(i, file, 56, 5, 1633);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(a, "href", "javascript:");
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(a, "class", "btn btn-sm btn-success");
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.set_style)(a, "float", "right");
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(a, "disabled", a_disabled_value = /*args*/ ctx[0].max && /*fields*/ ctx[1].length > /*args*/ ctx[0].max);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.toggle_class)(a, "disabled", /*args*/ ctx[0].max && /*fields*/ ctx[1].length > /*args*/ ctx[0].max);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(a, file, 46, 4, 1211);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(div1, "class", "col-lg-6 pt-2 pt-lg-0");
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(div1, file, 29, 2, 741);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(div2, "class", "row px-3 pb-3");
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(div2, file, 22, 0, 492);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(input, "type", "text");
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(input, "class", "hidden");
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(input, "name", input_name_value = /*args*/ ctx[0].name);
			input.value = input_value_value = /*args*/ ctx[0].value;
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(input, file, 61, 2, 1723);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.set_style)(div3, "display", "none");
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(div3, file, 60, 0, 1693);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		m: function mount(target, anchor) {
			...
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.append_dev)(div3, input);
			current = true;

			if (!mounted) {
				dispose = (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.listen_dev)(a, "click", /*click_handler_1*/ ctx[4], false, false, false);
				mounted = true;
			}
		},
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*fields, Object*/ 2) {
				each_value = Object.keys(/*fields*/ ctx[1]);
				(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.validate_each_argument)(each_value);
				(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.group_outros)();
				(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.validate_each_keys)(ctx, each_value, get_each_context, get_key);
				each_blocks = (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.update_keyed_each)(each_blocks, dirty, get_key, 1, ctx, each_value, each_1_lookup, div1, svelte_internal__WEBPACK_IMPORTED_MODULE_0__.outro_and_destroy_block, create_each_block, t4, get_each_context);
				(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.check_outros)();
			}

			if (!current || dirty & /*args, fields*/ 3 && a_disabled_value !== (a_disabled_value = /*args*/ ctx[0].max && /*fields*/ ctx[1].length > /*args*/ ctx[0].max)) {
				(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(a, "disabled", a_disabled_value);
			}

			if (dirty & /*args, fields*/ 3) {
				(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.toggle_class)(a, "disabled", /*args*/ ctx[0].max && /*fields*/ ctx[1].length > /*args*/ ctx[0].max);
			}
			...
			if (!current || dirty & /*args*/ 1 && input_value_value !== (input_value_value = /*args*/ ctx[0].value) && input.value !== input_value_value) {
...
function instance($$self, $$props, $$invalidate) {
	let { $$slots: slots = {}, $$scope } = $$props;
	(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.validate_slots)('VariableField', slots, []);
	let { args } = $$props;
	let fields = {};
	let id_counter = 0;
	...
	Object_1.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<VariableField> was created with unknown prop '${key}'`);
	});

	const click_handler = value_id => {
	...
	const click_handler_1 = () => {
		...
		$$invalidate(
			1,
			fields[$$invalidate(2, id_counter++, id_counter)] = {
				...args.field,
				args: {
					...args.field.args,
					name: `${args.field.args.name}${id_counter}`
	...
	$$self.$capture_state = () => ({ SSRField: _components_app_SSRField_svelte__WEBPACK_IMPORTED_MODULE_1__["default"], args, fields, id_counter });

	$$self.$inject_state = $$props => {
		if ('args' in $$props) $$invalidate(0, args = $$props.args);
		if ('fields' in $$props) $$invalidate(1, fields = $$props.fields);
		if ('id_counter' in $$props) $$invalidate(2, id_counter = $$props.id_counter);
	};
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*fields*/ 2) {
			$: $$invalidate(0, args.value = JSON.stringify(Object.values(fields).map(field => ({ '$ref': `#/${field.args.name}` }))), args);
		}
	};

	return [args, fields, id_counter, click_handler, click_handler_1];
}

class VariableField extends svelte_internal__WEBPACK_IMPORTED_MODULE_0__.SvelteComponentDev {
	constructor(options) {
		super(options);
		(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.init)(this, options, instance, create_fragment, svelte_internal__WEBPACK_IMPORTED_MODULE_0__.safe_not_equal, { args: 0 });

		(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.dispatch_dev)("SvelteRegisterComponent", {
			component: this,
			tagName: "VariableField",
			options,
			id: create_fragment.name
		});
		...
		if (/*args*/ ctx[0] === undefined && !('args' in props)) {
			console.warn("<VariableField> was created without expected prop 'args'");
		}
	}

	get args() {
		throw new Error("<VariableField>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
	}

	set args(value) {
		throw new Error("<VariableField>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
	}
}

if (module && module.hot) {}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (VariableField);
...
/******/ 	var __webpack_exports__ = __webpack_require__("./profiles/default/js/fields/VariableField.svelte");
/******/ 	
/******/ 	return __webpack_exports__;
/******/ })()
;
});
//# sourceMappingURL=VariableField.js.map